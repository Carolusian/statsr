...
- R2 Statistic (R square):  $R^2 = \frac{TSS - RSS}{TSS}$ close to 1 indicates that a large proportion of the variability in the response is explained, similar to correlation
- F-statistic: $F = \frac{(TSS - RSS)/p}{RSS/(n - p - 1)}$ Test the H0 that all coefficients are zero. If F close to 1, no relationship between Xs and Y; If F larger than 1, otherwise.
